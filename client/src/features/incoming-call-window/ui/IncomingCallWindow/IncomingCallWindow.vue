<script setup lang="ts">
    ...
    const getIncomingCall = ({ from, type }: { from: string; type: 'voice' | 'video' }) => {
    ...
    onUnmounted(() => {
        ...
        socket.off('webrtc:offer', ({ offer }) => incomingCallStore.setOffer(offer));
    });
</script>
...
<template>
    <ModalTransition>
        ...
        >
            <div class="relative w-[300px] h-[325px] bg-mainGray p-2 flex-col justify-between">
