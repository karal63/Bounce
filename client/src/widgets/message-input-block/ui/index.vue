<script setup lang="ts">
    ...
    watch(
        ...
        newContent => {
            ...
            cursorPos.value = (inputRef.value as HTMLTextAreaElement).selectionStart;
...
<template>
    <div v-if="currentChatStore.currentRoom.id" class="h-[10%] flex justify-center w-full">
        <div
        ...
        >
            ...
            <form class="flex items-center gap-2">
                <button @click.prevent="areAttachmentsOpen = true" class="cursor-pointer">
                    <Icon icon="iconoir:plus" class="text-purple-400 text-4xl" />
                </button>
                <textarea
