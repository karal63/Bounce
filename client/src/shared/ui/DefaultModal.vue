...
<template>
    ...
    >
        <ModalTransition name="zoom-fade">
            <div
                v-show="showContent"
                class="w-[400px] h-[300px] pb-3 px-4 transition-all duration-300 ease-in-out overflow-hidden bg-mainBorder border border-white/10 rounded-xl flex flex-col gap-3"
            >
